  ...
  return (
    <div className="sr-only relative bottom-0  bg-slate-400 max-[1000px]:absolute sm:not-sr-only">
      <div id="ASIDE-NAV" className="max-[1500px]  bg-zinc-50  ">
        ...
        <div className="Side-Nav px-4">
          <div
            id="page-navigation"
            className="top-0 top-4 min-[1000px]:pl-0 xl:absolute "
          >
           ...
           lg:flex-none lg:items-center lg:whitespace-nowrap lg:py-12  lg:text-sm lg:leading-7"
            >
              ...
              <div
                id="episodes"
                className="mx-auto mx-auto bg-black  sm:px-6 min-[1000px]:hidden lg:px-0 "
              >
                <h1
                  className="mx-auto  py-10 text-4xl font-bold  leading-7
             ...
             md:max-w-2xl md:px-4 md:py-12 lg:px-0 lg:px-0 xl:pl-32 "
              ...
              <div
                id="collection"
                className="flex max-w-[391px] overflow-scroll
               rounded-sm bg-gray-200 bg-white/90 px-3 text-sm font-medium text-zinc-800
               shadow-lg shadow-zinc-400/5 backdrop-blur
                hover:shadow-zinc-900/5 dark:bg-zinc-800/90
